# Simple initramfs image suitable for booting the MitySOMA10S
#
# 
SUMMARY = "Initramfs image supporting overlayfs"
DESCRIPTION = "Small image capable of booting a MitySOMA10S module entirely from \
...
COMPATIBLE_MACHINE = "mitysoma10s"
...
rootfs_tuning_filesystem() {
    ...
    echo "MitySOMA10S INITRAMFS" >> ${IMAGE_ROOTFS}/etc/issue
}